...
public class FloorVisibilityManager : MonoBehaviour
{
    ...
    {
        // No dependency on Features/NpcController
        var behaviours = FindObjectsByType<MonoBehaviour>(FindObjectsSortMode.None);
        foreach (var mb in behaviours)
        {
            if (mb is IFloorVisibilityAware aware)
                aware.UpdateVisibilityBasedOnPlayerFloor(playerFloor);
        }
    }
    ...
    public void SetVisibleFloor(FloorLevel floor) => UpdateFloorVisibility(floor);
